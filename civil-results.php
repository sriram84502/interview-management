<?php
    ...
    include 'conn.php';
    $query = "SELECT * FROM candidate_marks WHERE branch='civil' GROUP BY email;";
      ...
      <div class="col"> 
        <div class="card card-custom">
          ...
          <div class="card-body card-body-custom">
            ...
            <form action="cse-results" style="display:contents" method="post">
